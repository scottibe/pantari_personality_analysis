...
User.destroy_all
PantariPersonalityAnalysis.destroy_all
PantariToneAnalysis.destroy_all

bewick = PersonalityApiCaller.new(File.open("/Users/scottbewick/Development/code/mytext.rtf", "r"))
sbews = PantariPersonalityAnalysis.create(bewick.scores_to_hash)
